...
Variable::Variable(DeviceDescription::ILogical::Type::Enum variableType) : Variable() {
  switch (variableType) {
    case DeviceDescription::ILogical::Type::Enum::none: type = VariableType::tVoid;
      break;
    case DeviceDescription::ILogical::Type::Enum::tAction: type = VariableType::tBoolean;
      break;
    case DeviceDescription::ILogical::Type::Enum::tArray: type = VariableType::tArray;
      break;
    case DeviceDescription::ILogical::Type::Enum::tBoolean: type = VariableType::tBoolean;
      break;
    case DeviceDescription::ILogical::Type::Enum::tEnum: type = VariableType::tInteger;
      break;
    case DeviceDescription::ILogical::Type::Enum::tFloat: type = VariableType::tFloat;
      break;
    case DeviceDescription::ILogical::Type::Enum::tInteger: type = VariableType::tInteger;
      break;
    case DeviceDescription::ILogical::Type::Enum::tInteger64: type = VariableType::tInteger64;
      break;
    case DeviceDescription::ILogical::Type::Enum::tString: type = VariableType::tString;
      break;
    case DeviceDescription::ILogical::Type::Enum::tStruct: type = VariableType::tStruct;
      break;
  }
}
...
PVariable Variable::fromString(std::string &value, DeviceDescription::ILogical::Type::Enum type) {
  ...
  switch (type) {
    case DeviceDescription::ILogical::Type::Enum::none: break;
    case DeviceDescription::ILogical::Type::Enum::tAction: variableType = VariableType::tBoolean;
      break;
    case DeviceDescription::ILogical::Type::Enum::tBoolean: variableType = VariableType::tBoolean;
      break;
    case DeviceDescription::ILogical::Type::Enum::tEnum: variableType = VariableType::tInteger;
      break;
    case DeviceDescription::ILogical::Type::Enum::tFloat: variableType = VariableType::tFloat;
      break;
    case DeviceDescription::ILogical::Type::Enum::tInteger: variableType = VariableType::tInteger;
      break;
    case DeviceDescription::ILogical::Type::Enum::tInteger64: variableType = VariableType::tInteger64;
      break;
    case DeviceDescription::ILogical::Type::Enum::tString: variableType = VariableType::tString;
      break;
    case DeviceDescription::ILogical::Type::Enum::tArray: variableType = VariableType::tArray;
      break;
    case DeviceDescription::ILogical::Type::Enum::tStruct: variableType = VariableType::tStruct;
      break;
  }
...
PVariable Variable::fromString(std::string &value, DeviceDescription::IPhysical::Type::Enum type) {
  VariableType variableType = VariableType::tVoid;
  switch (type) {
    case DeviceDescription::IPhysical::Type::Enum::none: break;
    case DeviceDescription::IPhysical::Type::Enum::tBoolean: variableType = VariableType::tBoolean;
      break;
    case DeviceDescription::IPhysical::Type::Enum::tInteger: variableType = VariableType::tInteger;
      break;
    case DeviceDescription::IPhysical::Type::Enum::tString: variableType = VariableType::tString;
      break;
  }
  return fromString(value, variableType);
}
