...
PVariable HomegearUiElement::getElementInfo() {
  ...
  if (type == Type::simple) {
    ...
    for (auto &variableInput : variableInputs) {
      ...
      if (variableInput->automationInfo) variableProperties->structValue->emplace("automationInfo", variableInput->automationInfo);
    ...
    for (auto &variableOutput : variableOutputs) {
      ...
      if (variableOutput->automationInfo) variableProperties->structValue->emplace("automationInfo", variableOutput->automationInfo);
