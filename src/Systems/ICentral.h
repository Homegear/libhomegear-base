...
public:
    ...
    virtual PVariable createDevice(PRpcClientInfo clientInfo, const std::string& code) { return Variable::createError(-32601, "Method not implemented for this central."); }
	...
	virtual PVariable getVariablesInRoom(PRpcClientInfo clientInfo, uint64_t roomId, bool checkDeviceAcls, bool checkVariableAcls);
	...
	virtual PVariable searchDevices(PRpcClientInfo clientInfo, const std::string& interfaceId) { return Variable::createError(-32601, "Method not implemented for this central."); }
